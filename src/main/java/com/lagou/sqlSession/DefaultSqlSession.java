...
public class DefaultSqlSession implements SqlSession {
    ...
    public void insert(String statement, Object parameter) throws Exception {
        ...
        simpleExecutor.insert(configuration, mappedStatement, parameter);
    }
    ...
    public void update(String statement, Object parameter) throws Exception {
        simpleExecutor simpleExecutor = new simpleExecutor();
        MappedStatement mappedStatement = configuration.getMappedStatementMap().get(statement);
        simpleExecutor.update(configuration, mappedStatement, parameter);
    }
    ...
    public void delete(String statement, Object parameter) throws Exception {
        ...
        simpleExecutor simpleExecutor = new simpleExecutor();
        MappedStatement mappedStatement = configuration.getMappedStatementMap().get(statement);
        simpleExecutor.delete(configuration, mappedStatement, parameter);
